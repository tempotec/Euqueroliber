...
function SolutionModal({ item, onClose }: SolutionModalProps) {
  ...
  return (
    <div
      className="fixed inset-0 z-[60] flex items-end justify-center bg-[#111827]/55 p-0 backdrop-blur-sm sm:items-center sm:p-6"
      role="dialog"
      aria-modal="true"
    ...
    >
      <motion.div
        ...
        className="max-h-[90vh] w-full max-w-3xl overflow-y-auto rounded-t-2xl border border-[#D9E2D0] bg-[#FBF8EF] shadow-2xl sm:rounded-2xl"
      ...
      >
        <div className="relative">
          ...
          <button
            ...
            className="absolute right-3 top-3 inline-flex h-9 w-9 items-center justify-center rounded-full bg-[#111827]/80 text-white shadow transition hover:bg-[#111827] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#F2B705] focus-visible:ring-offset-2"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <div className="px-5 py-6 md:px-8 md:py-8">
          ...
          <div className="mt-6 grid gap-6 md:grid-cols-[1.05fr_0.95fr] md:items-start">
            <div>
              <h3 className="text-sm font-semibold uppercase tracking-[0.12em] text-[#D97706]">Como atuamos</h3>
...
export function Solucoes() {
  ...
  const open = useCallback((item: SolutionContent) => setActive(item), [])
